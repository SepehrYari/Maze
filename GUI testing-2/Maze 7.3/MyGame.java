...
public class MyGame extends JFrame implements ActionListener {
    ...
    /**
     * Creates the user input Window to display the Player's Name
     */
    ...
    public MyGame() {
        /**
         * the Scanner Class to open a window and set the Player's Name
         */
        playerName = getPlayerName();
        playerNameLabel = new JLabel("Player: " + playerName);
        
        /**
         * Pases the KeyLocation set up earlier and assignes the locations to the colored keys. 
         */
        ...
        panel5.add(playerNameLabel, BorderLayout.NORTH);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == northButton) {
            ...
            else if(knight.getPosition().getX() == 2 && knight.getPosition().getY() == 1 && knight.hasKey(EndKey) == false) 
            {
                // File I/O LO 10
                textBox.setText("Can't move this way...");
                knight.getPosition().setLocation(knight.getPosition().getX(), 0);
    ...
    /**
     * Method to Get the Player's Name used before the main game
     */
